...
<head>
    <title>Code coverage report for src/fetch.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> fetch.ts</h1>
        <div class='clearfix'>
  ...
  return await axios
    ...
    .catch((error) =&gt;
      axios.isAxiosError(error) &amp;&amp; error.response
        ? error.response.data
        : <span class="branch-1 cbranch-no" title="branch not covered" >Promise.reject(error)</span>
    );
}
&nbsp;</pre></td></tr></table></pre>
