...
declare type AccountBalanceDetails = {
    /**
     * Общий баланс счета.
     */
    total: number;
...
declare type AccountLinkedCard = {
    /**
...
export declare type AccountInfoResponse = {
    /**
...
declare type DigitalGoodsDescription = {
    article: DigitalGood[];
    [key: string]: any;
};
...
export declare type OperationHistoryResponse = {
    next_record: string;
 ...
 */
export declare type P2PPaymentRequest = Pick<Operation, "amount" | "amount_due" | "comment" | "message" | "codepro"> & {
    /**
 ...
 */
export declare type PhoneProviderPaymentRequest = {
    /**
...
export declare type RequestPaymentMoneySource = {
    wallet: {
        /**
...
export declare type RequestPaymentResponse = BaseApiErrors & {
    /**
...
export declare type ProcessPaymentResponse = {
    /**
     * Код результата выполнения операции. Возможные значения:
...
export declare type IncomingTransferAcceptResponse = BaseApiErrors & {
    /**
...
export declare type IncomingTransferRejectResponse = BaseApiErrors & {
    [key: string]: any;
};
export {};
