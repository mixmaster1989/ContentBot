...
export declare type PaymentStatus = "pending" | "waiting_for_capture" | "succeeded" | "canceled";
...
declare type BasePaymentMethod = {
    /**
     * Код способа оплаты.
     */
    type: string;
...
declare type AlfaClickPaymentMethod = BasePaymentMethod & {
    type: "alfabank";
    /**
...
declare type MobileBalancePaymentMethod = BasePaymentMethod & {
    type: "mobile_balance";
};
declare type CardPaymentMethod = BasePaymentMethod & {
    type: "bank_card";
    /**
...
declare type PayInPartsPaymentMethod = BasePaymentMethod & {
    type: "installments";
};
declare type CashPaymentMethod = BasePaymentMethod & {
    type: "cash";
};
declare type B2BSberbankPaymentMethod = BasePaymentMethod & {
    type: "b2b_sberbank";
    /**
...
declare type SberbankOnlinePaymentMethod = BasePaymentMethod & {
    type: "sberbank";
    /**
...
declare type TinkoffPaymentMethod = BasePaymentMethod & {
    type: "tinkoff_bank";
};
declare type YooMoneyPaymentMethod = BasePaymentMethod & {
    type: "yoo_money";
    /**
...
declare type ApplePayPaymentMethod = BasePaymentMethod & {
    type: "apple_pay";
};
declare type GooglePayPaymentMethod = BasePaymentMethod & {
    type: "google_pay";
};
declare type QiwiPaymentMethod = BasePaymentMethod & {
    type: "qiwi";
};
declare type WeChatPaymentMethod = BasePaymentMethod & {
    type: "wechat";
};
declare type WebMoneyPaymentMethod = BasePaymentMethod & {
    type: "webmoney";
};
declare type AnyPaymentMethod = AlfaClickPaymentMethod | MobileBalancePaymentMethod | CardPaymentMethod | PayInPartsPaymentMethod | CashPaymentMethod | B2BSberbankPaymentMethod | SberbankOnlinePaymentMethod | TinkoffPaymentMethod | YooMoneyPaymentMethod | ApplePayPaymentMethod | GooglePayPaymentMethod | QiwiPaymentMethod | WeChatPaymentMethod | WebMoneyPaymentMethod;
declare type PaymentConfirmation = {
    type: "embedded";
    /**
...
export declare type Payment = {
    ...
    cancellation_details?: {
         ...
         */
        reason: "3d_secure_failed" | "call_issuer" | "canceled_by_merchant" | "card_expired" | "country_forbidden" | "expired_on_capture" | "expired_on_confirmation" | "fraud_suspected" | "general_decline" | "identification_required" | "insufficient_funds" | "internal_timeout" | "invalid_card_number" | "invalid_csc" | "issuer_unavailable" | "payment_method_limit_exceeded" | "payment_method_restricted" | "permission_revoked" | "unsupported_mobile_operator";
    };
    /**
...
export declare type VatCodeType = 1 | 2 | 3 | 4 | 5 | 6;
export declare type ReceiptCustomer = {
    full_name?: string;
    inn?: string;
    email?: string;
    phone?: string;
};
export declare type ReceiptItem = {
    description?: string;
    quantity?: string;
    amount: PaymentAmount;
    vat_code: VatCode | VatCodeType;
};
export declare type PaymentCreationParameters = Pick<Payment, "amount" | "description" | "confirmation" | "metadata" | "transfers"> & {
